...
<html>
<head>
    <title>Buy Book - Qabas's Library</title>
    <link rel="stylesheet" type="text/css" href="./css/styleBuyBook.css">
...
<body bgcolor="0c164d">
    <font color="white">
        ...
        <div>
            <center>
                <form action="buyBookPost.php" method="post">
                    <fieldset >
                        <legend>Buy Book</legend>
                    ...
                    <button type="submit" name="buyBook">Buy Book</button>
                    <script>
                    <?php 
                         if (isset($sqlErorr)) {
